...
} from '../models/character-ascension-material.model';
...
export class CharacterAscensionMaterialService {
  ...
  constructor(http: HttpClient, private logger: NGXLogger) {
    http
      .get<CharacterAscensionMaterial>(
        materialData('character-ascension-materials'),
      )
      .subscribe(data => {
  ...
  get(group: number, rarity: Rarity): CharacterAscensionMaterialItem {
